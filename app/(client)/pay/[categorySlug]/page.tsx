...
export default async function DynamicServiceCategoryPage({ params }: { params: { categorySlug: string } }) {
    ...
    const services = await api.getServicesByCategory(params.categorySlug);
