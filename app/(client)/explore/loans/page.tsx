                                ...
                                <div className="flex items-center gap-4 mt-auto pt-4 border-t w-full">
                                    ...
                                    <div>
                                        <p className="text-[9px] text-muted-foreground font-medium uppercase tracking-wider">
                                            {prodTerms?.blockType === 'fixed-deposit-terms' ? 'Min Deposit' : 'Max Amount'}
                                        </p>
                                        <p className="text-sm font-bold">₦{((prodTerms?.blockType === 'fixed-deposit-terms' ? prodTerms?.min_amount : prodTerms?.max_amount) || 0).toLocaleString()}</p>
                                    </div>
                                </div>
