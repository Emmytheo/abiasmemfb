...
export function EmployeeSpotlight() {
    return (
        <section className="py-20 bg-gray-50 dark:bg-black/50 border-y border-gray-200 dark:border-white/5 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-primary dark:bg-white/5 rounded-2xl overflow-hidden shadow-2xl">
