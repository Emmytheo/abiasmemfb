...
export function EventsSection() {
    return (
        <section className="w-full bg-white dark:bg-[#0b101e] py-24 px-6 lg:px-12 transition-colors duration-300">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <span className="text-accent text-xs font-bold uppercase tracking-widest mb-3 block">Events & Training</span>
                    <h2 className="text-3xl md:text-5xl text-gray-900 dark:text-white font-display">Upcoming Workshops</h2>
                </div>

                <div className="flex flex-col gap-4 max-w-4xl mx-auto">
                    {/* Event Card 1 */}
                    <div className="group relative bg-gray-50 dark:bg-card-dark border border-gray-200 dark:border-white/5 hover:border-accent/50 p-6 md:p-8 rounded-xl transition-all duration-300 hover:shadow-lg">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10">
                            <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-6 md:gap-8 w-full">
                                <div className="flex flex-col items-center justify-center w-20 h-20 md:w-24 md:h-24 bg-white dark:bg-black border border-gray-200 dark:border-white/10 rounded-lg shrink-0 group-hover:scale-105 transition-transform duration-300 shadow-sm">
                                    <span className="text-xs text-accent font-bold uppercase tracking-widest mb-1">OCT</span>
                                    <span className="text-3xl text-gray-900 dark:text-white font-serif font-medium">12</span>
                                </div>
                                <div className="flex flex-col justify-center">
                                    <h3 className="text-xl md:text-2xl text-gray-900 dark:text-white font-display group-hover:text-accent transition-colors mb-2">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10">
                            <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-6 md:gap-8 w-full">
                                <div className="flex flex-col items-center justify-center w-20 h-20 md:w-24 md:h-24 bg-white dark:bg-black border border-gray-200 dark:border-white/10 rounded-lg shrink-0 group-hover:scale-105 transition-transform duration-300 shadow-sm">
                                    ...
                                    <span className="text-3xl text-gray-900 dark:text-white font-serif font-medium">05</span>
                                </div>
                                <div className="flex flex-col justify-center">
                                    <h3 className="text-xl md:text-2xl text-gray-900 dark:text-white font-display group-hover:text-accent transition-colors mb-2">
                ...
                <div className="text-center mt-12">
                    <a className="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-accent transition-colors border-b border-transparent hover:border-accent pb-1 cursor-pointer">
