        ...
        return (
            <form className={`space-y-5 relative z-10 ${className}`} onSubmit={handleSubmit}>
                <input
                    ...
                    className="block w-full px-4 py-4 border border-border bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:border-accent focus:ring-0 sm:text-sm transition-all rounded-none"
                />
    ...
    return (
        <form className={`flex flex-col sm:flex-row gap-4 max-w-lg mx-auto ${className}`} onSubmit={handleSubmit}>
            <input
                ...
                className="flex-1 bg-background border border-border rounded-lg px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent focus:ring-1 focus:ring-primary transition-all"
            />
